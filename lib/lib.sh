...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/CopilotGitBr/pterodactyl-installer"}
...
welcome() {
  ...
  output "https://github.com/CopilotGitBr/pterodactyl-installer"
  output ""
